...
namespace UserStorySoftwareTester
{
    public partial class report : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection con = new MySqlConnection("server=localhost;user id=root;database=userstory");
            con.Open();
            MySqlCommand cmd = new MySqlCommand("INSERT INTO reports (`tester`, `date`, `app_name`, `reports`, `improvements`) VALUES ('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "', '" + textBox4.Text + "')", con);
            cmd.ExecuteNonQuery();
