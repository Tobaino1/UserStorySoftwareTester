...
namespace UserStorySoftwareTester
{
    public partial class report : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            cmd.ExecuteNonQuery();
            MessageBox.Show("reports has been succesfully inserted in the database, click refresh button");
            con.Close();
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (textBox2.Text == string.Empty)
            {
                MessageBox.Show("application name field can't be empty, please enter the customer phone no & click delete button in the order to delete the record!");
                return;
